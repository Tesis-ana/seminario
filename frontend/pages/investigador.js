...
export default function Investigador() {
    ...
    return (
        <Layout
            subtitle='Interfaz de Investigador'
            actions={
                <>
        ...
        >
            {metrics && (
                <div className='card'>
                    ...
                    <p>
                        <strong>IoU:</strong> {metrics.iou}
                    </p>
                    <p>
                        <strong>Spearman:</strong> {metrics.spearman}
                    </p>
                    <p>
                        <strong>Actualizado:</strong> {metrics.updated_at}
                    </p>
                </div>
            )}
            {catMetrics && (
            ...
            <div className='card mt-1'>
                ...
                <form onSubmit={handleRetrain}>
                    <input
                        ...
                        onChange={(e) =>
                            setForm({ ...form, learning_rate: e.target.value })
                        }
                    />
                    <input
                        placeholder='epochs'
                        value={form.epochs}
                        onChange={(e) =>
                            setForm({ ...form, epochs: e.target.value })
                        }
                    />
